...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> ENDERITE_ORE_PLACED_KEY = ResourceKey.create(Registries.PLACED_FEATURE,
            new ResourceLocation(MoreTools.MOD_ID, "enderite_ore_placed"));
